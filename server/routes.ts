...
export async function registerRoutes(
  ...
  app.get("/sitemap.xml", (_req, res) => {
    const base = "https://puretyclinic.com";
    const today = new Date().toISOString().split("T")[0];

    const staticRoutes = [
      { url: "/", priority: "1.0", changefreq: "weekly" },
      { url: "/fecal-transplant", priority: "1.0", changefreq: "monthly" },
      { url: "/about", priority: "0.8", changefreq: "monthly" },
      { url: "/services", priority: "0.8", changefreq: "monthly" },
      { url: "/services/regenerative", priority: "0.7", changefreq: "monthly" },
      { url: "/services/iv-therapy", priority: "0.7", changefreq: "monthly" },
      { url: "/services/naturopathic", priority: "0.7", changefreq: "monthly" },
      { url: "/services/ozone-therapy", priority: "0.7", changefreq: "monthly" },
      { url: "/services/hormone-replacement", priority: "0.7", changefreq: "monthly" },
      { url: "/services/cancer-support", priority: "0.7", changefreq: "monthly" },
      { url: "/services/plasma-exchange", priority: "0.7", changefreq: "monthly" },
      { url: "/blog", priority: "0.8", changefreq: "weekly" },
      { url: "/contact", priority: "0.7", changefreq: "monthly" },
      { url: "/faqs", priority: "0.6", changefreq: "monthly" },
      { url: "/testimonials", priority: "0.6", changefreq: "monthly" },
      { url: "/shop", priority: "0.5", changefreq: "weekly" },
    ];

    const blogPosts = [
      { id: "fmt-success-rate-and-cost", date: "2026-04-17" },
      { id: "how-to-get-fmt-treatment", date: "2026-04-10" },
      { id: "fmt-delivery-methods", date: "2026-04-04" },
      { id: "fmt-sibo-research", date: "2026-03-28" },
      { id: "fmt-ibs-research", date: "2026-03-22" },
      { id: "fmt-ulcerative-colitis-research", date: "2026-03-15" },
      { id: "fmt-crohns-research", date: "2026-03-08" },
      { id: "aip-diet-autoimmune", date: "2026-02-22" },
      { id: "iv-therapy-guide", date: "2024-03-15" },
      { id: "prp-therapy-guide", date: "2024-02-20" },
      { id: "healing-power-nature", date: "2023-10-12" },
      { id: "ozone-therapy-overview", date: "2023-09-05" },
      { id: "bioidentical-hormones", date: "2023-08-18" },
      { id: "gut-microbiome-health", date: "2023-07-22" },
    ];
