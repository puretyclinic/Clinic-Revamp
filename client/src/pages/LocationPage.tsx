...
const locations: Record<string, LocationData> = {
  ...
  "santa-monica": {
    ...
    metaTitle: "FMT · EBO2 Ozone · PRP · Plasma Exchange Near Santa Monica CA | Purety Clinic Santa Barbara",
  ...
  "malibu": {
    ...
    metaDescription: "Malibu patients travel 70 miles to Purety Clinic Santa Barbara for FMT, EBO2 ozone, PRP & therapeutic plasma exchange. Dr. Birch NMD, RMSK. (805) 500-8300.",
  ...
  "bakersfield": {
    ...
    metaDescription: "Bakersfield patients travel 2 hours to Purety Clinic Santa Barbara for FMT, EBO2 ozone, PRP & plasma exchange. No local providers in Kern County. Dr. Birch NMD. (805) 500-8300.",
