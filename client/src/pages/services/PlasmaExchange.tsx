            ...
            <FadeIn>
              ...
              <ol className="relative border-l border-gray-200 ml-3 space-y-8 mb-12">
                {[
                  ...
                  { step: "2", title: "Pre-Procedure Labs", body: "Before your first session (and, if needed, before each subsequent session), we review CBC, metabolic panel, coagulation studies, albumin, and condition-specific autoantibody markers to confirm it's safe to proceed." },
